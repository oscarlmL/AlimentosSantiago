# Generated by Django 2.2.13 on 2021-10-13 18:43
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('enc_cocina', models.ForeignKey(db_column='enc_cocina_id_enc_cocina', null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='OrderFood.EncCocina')),
            ],
            options={
                'db_table': 'restaurant',
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Ingrediente', models.ForeignKey(null=True, on_delete=django.db.models.deletion.PROTECT, to='OrderFood.Ingrediente')),
                ('Restaurant', models.ForeignKey(null=True, on_delete=django.db.models.deletion.PROTECT, to='OrderFood.Restaurant')),
            ],
            options={
                'db_table': 'plato',
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('estado', models.CharField(choices=[['Pendiente', 'Pendiente'], ['Confirmado', 'Confirmado'], ['En ruta', 'En ruta'], ['Entregado', 'Entregado']], max_length=50)),
