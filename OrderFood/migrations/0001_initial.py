# Generated by Django 3.2.8 on 2021-11-30 21:29
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('contraseña1', models.CharField(max_length=100)),
                ('contraseña2', models.CharField(max_length=100)),
                ('restaurant_id_restaurante', models.ForeignKey(db_column='restaurant_id_restaurante', default=1, on_delete=django.db.models.deletion.CASCADE, to='OrderFood.restaurant')),
            ],
            options={
                'db_table': 'cajero',
            },
